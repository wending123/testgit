...
public class StudentClassAdd extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudentClassAdd frame = new StudentClassAdd();
	 ...
	 * Create the frame.
	 */
	public StudentClassAdd() {
		setClosable(true);
	    setIconifiable(true);
		setTitle("\u6DFB\u52A0\u73ED\u7EA7\u4FE1\u606F");
		setBounds(100, 100, 425, 321);
		
		
	
		JLabel label = new JLabel("\u73ED\u7EA7\u540D\u79F0\uFF1A");
		label.setIcon(new ImageIcon(StudentClassAdd.class.getResource("/images/\u73ED\u7EA7\u540D\u79F0.png")));
		...
		label_1.setIcon(new ImageIcon(StudentClassAdd.class.getResource("/images/\u73ED\u7EA7\u4ECB\u7ECD.png")));
		...
		submitButton.setIcon(new ImageIcon(StudentClassAdd.class.getResource("/images/\u786E\u8BA4.png")));
		...
		restButton.setIcon(new ImageIcon(StudentClassAdd.class.getResource("/images/\u91CD\u7F6E.png")));
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
							...
							.addComponent(classInfoTextArea, GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))
		...
		groupLayout.setVerticalGroup(
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(label_1)
						.addComponent(classInfoTextArea, GroupLayout.PREFERRED_SIZE, 88, GroupLayout.PREFERRED_SIZE))
